...
function App() {
    ...
    const handleFormSubmit = async (e) => {
        ...
        try {
            ...
            if (editingQuotation) {
                    ...
                    // Extract the task code from the quotation (format: "description - code")

                    const cotacaoCode = editingQuotation.cotacao.includes(' - ') 

                        ? editingQuotation.cotacao.split(' - ')[1] 

                        : editingQuotation.cotacao;
    ...
    const confirmDelete = async () => {
        ...
        try {
            ...
            const cotacaoCode = deleteModal.cotacao.includes(' - ') 

                ? deleteModal.cotacao.split(' - ')[1] 
                            ...
                            <table className="min-w-full divide-y divide-slate-200">
                                ...
                                <thead className="bg-slate-50">
                                    ...
                                    <tr>
                                        ...
                                        <th className="px-6 py-3 text-left text-xs font-semibold text-slate-500 uppercase tracking-wider">Demanda</th>
                            ...
                            <table className="min-w-full divide-y divide-slate-200">
                                ...
                                <thead className="bg-slate-50">
                                    ...
                                    <tr>
                                        ...
                                        <th className="px-6 py-3.5 text-left text-xs font-semibold text-slate-500 uppercase tracking-wider">Demanda</th>
